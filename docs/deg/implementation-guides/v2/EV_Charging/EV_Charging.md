...
* [1. Request for Comments](EV_Charging.md#1-request-for-comments)
* [2. Copyright Notice](EV_Charging.md#2-copyright-notice)
* [3. Status of This Memo](EV_Charging.md#3-status-of-this-memo)
* [4. Abstract](EV_Charging.md#4-abstract)
* [5. Introduction](EV_Charging.md#5-introduction)
* [6. Scope](EV_Charging.md#6-scope)
* [7. Intended Audience](EV_Charging.md#7-intended-audience)
* [8. Conventions and Terminology](EV_Charging.md#8-conventions-and-terminology)
* [9. Terminology](EV_Charging.md#9-terminology)
* [10. Reference Architecture](EV_Charging.md#10-reference-architecture)
  * [10.1. Architecture Diagram](EV_Charging.md#101-architecture-diagram)
  * [10.2. Actors](EV_Charging.md#102-actors)
* [11. Creating an Open Network for EV Charging](EV_Charging.md#11-creating-an-open-network-for-ev-charging)
  * [11.1. Setting up a Registry](EV_Charging.md#111-setting-up-a-registry)
    * [11.1.1. For a Network Participant](EV_Charging.md#1111-for-a-network-participant)
      * [11.1.1.1. Step 1 : Claiming a Namespace](EV_Charging.md#11111-step-1---claiming-a-namespace)
      * [11.1.1.2. Step 2 : Setting up a Registry](EV_Charging.md#11112-step-2---setting-up-a-registry)
      * [11.1.1.3. Step 3 : Publishing subscriber details](EV_Charging.md#11113-step-3---publishing-subscriber-details)
    * [11.1.2. Step 4 : Share details of the registry created with the Beckn One team](EV_Charging.md#1112-step-4---share-details-of-the-registry-created-with-the-beckn-one-team)
    * [11.1.3. For a Network facilitator organization](EV_Charging.md#1113-for-a-network-facilitator-organization)
      * [11.1.3.1. Step 1 : Claiming a Namespace](EV_Charging.md#11131-step-1---claiming-a-namespace)
      * [11.1.3.2. Step 2 : Setting up a Registry](EV_Charging.md#11132-step-2---setting-up-a-registry)
      * [11.1.3.3. Step 3 : Publishing subscriber details](EV_Charging.md#11133-step-3---publishing-subscriber-details)
      * [11.1.3.4. Step 4 : Share details of the registry created with the Beckn One team](EV_Charging.md#11134-step-4---share-details-of-the-registry-created-with-the-beckn-one-team)
  * [11.2. Setting up the Protocol Endpoints](EV_Charging.md#112-setting-up-the-protocol-endpoints)
    * [11.2.1. Installing Beckn ONIX](EV_Charging.md#1121-installing-beckn-onix)
    * [11.2.2. Configuring Beckn ONIX for EV Charging Transactions](EV_Charging.md#1122-configuring-beckn-onix-for-ev-charging-transactions)
    * [11.2.3. 10.2.3 Performing a test EV charging transaction](EV_Charging.md#1123-1023-performing-a-test-ev-charging-transaction)
* [12. Implementing EV Charging Semantics on Beckn Protocol](EV_Charging.md#12-implementing-ev-charging-semantics-on-beckn-protocol)
  * [12.1. Key Assumptions](EV_Charging.md#121-key-assumptions)
  * [12.2. Semantic Model](EV_Charging.md#122-semantic-model)
  * [12.3. Example Category Codes](EV_Charging.md#123-example-category-codes)
* [13. Example Workflows (EV User’s Perspective)](EV_Charging.md#13-example-workflows-ev-users-perspective)
  * [13.1. Example 1 - Walk-In to a charging station without reservation.](EV_Charging.md#131-example-1---walk-in-to-a-charging-station-without-reservation)
    * [13.1.1. Consumer User Journey](EV_Charging.md#1311-consumer-user-journey)
    * [13.1.2. **API Calls and Schema**](EV_Charging.md#1312-api-calls-and-schema)
      * [13.1.2.1. `action: discover`](EV_Charging.md#13121-action-discover)
      * [13.1.2.2. `action: on_discover`](EV_Charging.md#13122-action-on_discover)
      * [13.1.2.3. `action: select`](EV_Charging.md#13123-action-select)
      * [13.1.2.4. `action: on_select`](EV_Charging.md#13124-action-on_select)
      * [13.1.2.5. `action: init`](EV_Charging.md#13125-action-init)
      * [13.1.2.6. `action: on_init`](EV_Charging.md#13126-action-on_init)
      * [13.1.2.7. 13.1.2.6.1 `action: on_status`](EV_Charging.md#13127-131261-action-on_status)
      * [13.1.2.8. `action: confirm`](EV_Charging.md#13128-action-confirm)
      * [13.1.2.9. `action: on_confirm`](EV_Charging.md#13129-action-on_confirm)
      * [13.1.2.10. `action: status`](EV_Charging.md#131210-action-status)
      * [13.1.2.11. `action: on_status`](EV_Charging.md#131211-action-on_status)
      * [13.1.2.12. `action: update` (start charging)](EV_Charging.md#131212-action-update-start-charging)
      * [13.1.2.13. `action: on_update` (start charging)](EV_Charging.md#131213-action-on_update-start-charging)
      * [13.1.2.14. `action: status` (charging-session progress)](EV_Charging.md#131214-action-status-charging-session-progress)
      * [13.1.2.15. `action: on_status`](EV_Charging.md#131215-action-on_status)
      * [13.1.2.16. async `action: on_status`](EV_Charging.md#131216-async-action-on_status)
      * [13.1.2.17. `action: on_update` (stop-charging)](EV_Charging.md#131217-action-on_update-stop-charging)
      * [13.1.2.18. async `action: on_update` (stop-charging)](EV_Charging.md#131218-async-action-on_update-stop-charging)
      * [13.1.2.19. `action: rating`](EV_Charging.md#131219-action-rating)
      * [13.1.2.20. `action: on_rating`](EV_Charging.md#131220-action-on_rating)
      * [13.1.2.21. `action: support`](EV_Charging.md#131221-action-support)
      * [13.1.2.22. `action: on_support`](EV_Charging.md#131222-action-on_support)
  * [13.2. Use case 2- Reservation of an EV charging time slot.](EV_Charging.md#132-use-case-2--reservation-of-an-ev-charging-time-slot)
    * [13.2.0.1. Context:](EV_Charging.md#13201-context)
    * [13.2.0.2. Discovery](EV_Charging.md#13202-discovery)
      * [13.2.0.2.1. Adam discovers nearby charging services](EV_Charging.md#132021-adam-discovers-nearby-charging-services)
    * [13.2.0.3. Order (Reservation)](EV_Charging.md#13203-order-reservation)
    * [13.2.0.4. Fulfilment (Session Start & Tracking)](EV_Charging.md#13204-fulfilment-session-start--tracking)
    * [13.2.0.5. Post-Fulfilment](EV_Charging.md#13205-post-fulfilment)
    * [13.2.1. **API Calls and Schema**](EV_Charging.md#1321-api-calls-and-schema)
      * [13.2.1.1. `action: discover`](EV_Charging.md#13211-action-discover)
        * [13.2.1.1.1. Discovery of EV charging services within a circular boundary](EV_Charging.md#132111-discovery-of-ev-charging-services-within-a-circular-boundary)
        * [13.2.1.1.2. Discovery within circle + connector specs as filters](EV_Charging.md#132112-discovery-within-circle--connector-specs-as-filters)
        * [13.2.1.1.3. Discovery within circle + vehicle specifications as filters](EV_Charging.md#132113-discovery-within-circle--vehicle-specifications-as-filters)
        * [13.2.1.1.4. Discovery of services offered by a specific CPO](EV_Charging.md#132114-discovery-of-services-offered-by-a-specific-cpo)
        * [13.2.1.1.5. Viewing details of a single charging station (by its Item Identifier)](EV_Charging.md#132115-viewing-details-of-a-single-charging-station-by-its-item-identifier)
        * [13.2.1.1.6. Fetching details of a specific charger (EVSE) on-site (by its EVSE identifier)](EV_Charging.md#132116-fetching-details-of-a-specific-charger-evse-on-site-by-its-evse-identifier)
        * [13.2.1.1.7. Discovering chargers in a specific circular area, a specific connector type and availability time range](EV_Charging.md#132117-discovering-chargers-in-a-specific-circular-area-a-specific-connector-type-and-availability-time-range)
      * [13.2.1.2. `action: on_discover`](EV_Charging.md#13212-action-on_discover)
        * [13.2.1.2.1. Offers as part of the Catalog](EV_Charging.md#132121-offers-as-part-of-the-catalog)
      * [13.2.1.3. `action: select`](EV_Charging.md#13213-action-select)
      * [13.2.1.4. `action: on_select`](EV_Charging.md#13214-action-on_select)
        * [13.2.1.4.1. Surge Pricing](EV_Charging.md#132141-surge-pricing)
      * [13.2.1.5. `action: init`](EV_Charging.md#13215-action-init)
      * [13.2.1.6. `action: on_init`](EV_Charging.md#13216-action-on_init)
      * [13.2.1.7. `action: on_status` (payment)](EV_Charging.md#13217-action-on_status-payment)
      * [13.2.1.8. `action: confirm`](EV_Charging.md#13218-action-confirm)
      * [13.2.1.9. `action: on_confirm`](EV_Charging.md#13219-action-on_confirm)
      * [13.2.1.10. `action: update` (start charging)](EV_Charging.md#132110-action-update-start-charging)
      * [13.2.1.11. `action: on_update` (start charging)](EV_Charging.md#132111-action-on_update-start-charging)
      * [13.2.1.12. `action: status`](EV_Charging.md#132112-action-status)
      * [13.2.1.13. `action: on_status`](EV_Charging.md#132113-action-on_status)
      * [13.2.1.14. asynchronous `action: on_status` (temporary connection interruption)](EV_Charging.md#132114-asynchronous-action-on_status-temporary-connection-interruption)
        * [13.2.1.14.0.1. **A)Undercharge (Power Cut Mid-Session)**](EV_Charging.md#13211401-aundercharge-power-cut-mid-session)
        * [13.2.1.14.0.2. **B) Overcharge (Charger Offline to CMS; Keeps Dispensing)**](EV_Charging.md#13211402-b-overcharge-charger-offline-to-cms-keeps-dispensing)
      * [13.2.1.15. Asynchronous `action: on_update` (stop charging)](EV_Charging.md#132115-asynchronous-action-on_update-stop-charging)
      * [13.2.1.16. Synchronous/Asynchronous on\_update (stop charging)](EV_Charging.md#132116-synchronousasynchronous-on_update-stop-charging)
      * [13.2.1.17. `action: cancel`](EV_Charging.md#132117-action-cancel)
      * [13.2.1.18. `action: on_cancel`](EV_Charging.md#132118-action-on_cancel)
      * [13.2.1.19. `action: rating`](EV_Charging.md#132119-action-rating)
      * [13.2.1.20. `action: on_rating`](EV_Charging.md#132120-action-on_rating)
      * [13.2.1.21. `action: support`](EV_Charging.md#132121-action-support)
      * [13.2.1.22. `action: on_support`](EV_Charging.md#132122-action-on_support)
    * [13.2.2. **Integrating with your software**](EV_Charging.md#1322-integrating-with-your-software)
      * [13.2.2.1. **Integrating the BAP**](EV_Charging.md#13221-integrating-the-bap)
      * [13.2.2.2. **Integrating the BPP**](EV_Charging.md#13222-integrating-the-bpp)
  * [13.3. FAQs](EV_Charging.md#133-faqs)
  * [13.4. References](EV_Charging.md#134-references)
...
Example jsons were imported directly from source of truth elsewhere in this repo inline by inserting the pattern below within all json expand blocks, and running this [script](https://github.com/nirmal-inc/docs-test/blob/main/scripts/embed_example_json.py), e.g. `python3 scripts/embed_example_json.py docs/implementation-guides/v2/EV_Charging/EV_Charging.md`.
...
> Note: This document does not detail the mapping between Beckn Protocol and OCPI. Please refer to [this](https://github.com/nirmal-inc/docs-test/blob/main/docs/docs/implementation-guides/v1-EOS/DEG00x_Mapping-OCPI-and-Beckn-Protocol-for-EV-Charging-Interoperability.md) document for the same. BPPs are NOT aggregators. Any CPO that has implemented a Beckn Protocol endpoint is a BPP. For all sense and purposes, CPOs are essentially BPPs and eMSPs are essentially BAPs.
...
![](../../../../.gitbook/assets/beckn-one-deg-arch.png)
...
Step 1 : Download the postman collection, from [here](https://github.com/nirmal-inc/docs-test/blob/main/devkits/ev-charging/postman/README.md).
...
Note: The API calls and schema for walk-in charging are identical to the [advance reservation use case](EV_Charging.md#use-case-2--reservation-of-an-ev-charging-time-slot) with minor differences in timing and availability. Where sections reference Use Case 2, the same API structure, field definitions, and examples apply unless specifically noted otherwise.

**13.1.2.1. `action: discover`**

* Method: POST
* Use Cases: Raghav scans QR code on Charging Point Connector using his BAP user app
* Request: Fetching details of a specific Charging Point Connector (EVSE) after reaching site (using its identifier): [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/01_discover/discovery-by-EVSE.json)

<details>

<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/01_discover/discovery-by-EVSE.json">Example json :rocket:</a></summary>
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/02_on_discover/ev-charging-specific-evse-catalog.json">Example json :rocket:</a></summary>
...
CPO returns details of a specific charger: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/02_on_discover/ev-charging-specific-evse-catalog.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/03_select/ev-charging-select.json">Example json :rocket:</a></summary>
...
EV user requests charge worth in KWH: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/03_select/ev-charging-select.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/04_on_select/ev-charging-on-select.json">Example json :rocket:</a></summary>
...
CPO responds with dynamically calculated quote: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/04_on_select/ev-charging-on-select.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/05_init/ev-charging-bpp-payment-init.json">Example json :rocket:</a></summary>
...
EV user requests for payment information: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/05_init/ev-charging-bpp-payment-init.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/06_on_init/ev-charging-bpp-payment-on-init.json">Example json :rocket:</a></summary>
...
CPO responds with the payment link for the user to authorize payment: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/06_on_init/ev-charging-bpp-payment-on-init.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/06_on_status_1/ev-charging-bpp-payment-check-on-status.json">Example json :rocket:</a></summary>
...
CPO sends the status of the payment: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/06_on_status_1/ev-charging-bpp-payment-check-on-status.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/07_confirm/ev-charging-confirm.json">Example json :rocket:</a></summary>
...
EV user confirms reservation of a slot at a particular charging station at a particular time: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/07_confirm/ev-charging-confirm.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/08_00_on_confirm/ev-charging-on-confirm.json">Example json :rocket:</a></summary>
...
CPO responds with confirmed slot: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/08_00_on_confirm/ev-charging-on-confirm.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/08_01_status/ev-charging-connector-status.json">Example json :rocket:</a></summary>
...
The user checks the status of charging connector: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/08_01_status/ev-charging-connector-status.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/08_02_on_status/ev-charging-connector-on-status.json">Example json :rocket:</a></summary>
...
The CPO response with the status of the charging connector: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/08_02_on_status/ev-charging-connector-on-status.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/09_update/ev-charging-01-session-start-update.json">Example json :rocket:</a></summary>
...
EV user starts a charging session: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/09_update/ev-charging-01-session-start-update.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/10_on_update/ev-charging-session-on-update.json">Example json :rocket:</a></summary>
...
CPO responds with confirmed start of charging session: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/10_on_update/ev-charging-session-on-update.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/11_status/ev-charging-session-track.json">Example json :rocket:</a></summary>
...
EV User tracks a live charging session in real-time: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/11_status/ev-charging-session-track.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/12_on_status/ev-charging-session-on-track.json">Example json :rocket:</a></summary>
...
EV User receives a live charging session in real-time: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/12_on_status/ev-charging-session-on-track.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/13_on_status/ev-charging-session-interrupt-on-status.json">Example json :rocket:</a></summary>
...
EV user reveives a notification in case of any error occuring during charging session: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/13_on_status/ev-charging-session-interrupt-on-status.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/14_01_update/ev-charging-session-end-update.json">Example json :rocket:</a></summary>
...
EV user stops the charging session: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/14_01_update/ev-charging-session-end-update.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/14_02_on_update/ev-charging-session-complete-on-update.json">Example json :rocket:</a></summary>
...
EV user receives the session details upon chargign session end: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/14_02_on_update/ev-charging-session-complete-on-update.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/15_rating/ev-charging-session-rating.json">Example json :rocket:</a></summary>
...
EV user rates charging service experience: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/15_rating/ev-charging-session-rating.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/16_on_rating/ev-charging-session-on-rating.json">Example json :rocket:</a></summary>
...
CPO accepts rating: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/16_on_rating/ev-charging-session-on-rating.json)
...
EV user contacts support: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/17_support/ev-charging-session-support.json)

<details>

<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/17_support/ev-charging-session-support.json">Example json :rocket:</a></summary>
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/18_on_support/ev-charging-session-on-support.json">Example json :rocket:</a></summary>
...
CPO returns support information: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/18_on_support/ev-charging-session-on-support.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/01_discover/discovery-within-a-circular-boundary.json">Example json :rocket:</a></summary>
...
Discovery of EV charging services within a circular boundary: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/01_discover/discovery-within-a-circular-boundary.json)
...
Discovery of EV Charging stations within a circular boundary using connector specs as filters: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/01_discover/discovery-within-boundary-with-connection-spec.json)
...
Discovery of EV Charging stations within circular boundary using vehicle specifications as filters: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/01_discover/discovery-within-boundary-with-vehicle-spec.json)
...
Discovery of EV charging services offered by a specific CPO: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/01_discover/discovery-services-by-a-cpo.json)
...
Viewing details of a single charging station (using its Identifier): [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/01_discover/discovery-services-by-a-station.json)
...
Fetching details of a specific charger (EVSE) after reaching site (using its identifier): [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/01_discover/discovery-by-EVSE.json)
...
Discovering chargers in a specific circular area, a specific connector type and availability time range: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/01_discover/discovery-within-a-timerange.json)
...
1. **filters**
   ...
   4. Example: "$\[?(@.itemAttributes\['connector-type']=='CCS2' && @.availableAt\[_].gps.latitude>=12 && @.availableAt\[_].gps.latitude<=13)]"
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/02_on_discover/ev-charging-discovery-catalog.json">Example json :rocket:</a></summary>
...
CPO returns EV Charging Service Catalog Listing: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/02_on_discover/ev-charging-discovery-catalog.json)
...
* Request: EV user requests charge worth specific KWH: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/03_select/ev-charging-select.json)
...
2. **Beckn:fulfillment:**
   1. Describes the _intended charging session details_ for scheduling and compatibility checks.
...
* Request: CPO responds with dynamically calculated quote: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/04_on_select/ev-charging-on-select.json)
...
* Request: The BAP app requests the final quote and payment terms by submitting billing details along with approval from the BPP to collect the payment: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/05_init/ev-charging-bap-payment-init.json)

1. **order.beckn**:id: When the BAP collects the payment, it generates the orderId and includes it in the init payload sent to the BPP.
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/05_init/ev-charging-bap-payment-init.json">Example json :rocket:</a></summary>
...
*   Request: The CPO confirms acceptance of BAP-led payment collection and shares the BPP’s settlement account details: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/06_on_init/ev-charging-bpp-payment-on-init.json)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/06_on_init/ev-charging-bap-payment-on-init.json">Example json :rocket:</a></summary>
...
*   Request: EV user confirms reservation of a slot at a particular charging station at a particular time: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/07_confirm/ev-charging-confirm.json)

    1. **beckn:payment:**\
       Captures the _final_ payment record returned after successful transaction confirmation — this confirms the completion of the payment flow.
    2. **beckn:status:**\
    ...
    4. **schema:totalPaymentReceived:**\
       Represents the _actual_ amount confirmed as received, mirroring the captured transaction amount for accounting consistency.
...
*   Request: CPO responds with confirmed slot: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/08_00_on_confirm/ev-charging-on-confirm.json)

    **ev:fulfillmentstate:**\
    Represents the _real-time operational state_ of the charging session.
...
*   Request: EV user starts a charging session: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/09_update/ev-charging-01-session-start-update.json) **beckn:fulfillment.ev:fulfillmentstate:** Communicates the _real-time operational status_ of the charging session.
...
*   Request: CPO starts a charging session: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/10_on_update/ev-charging-session-on-update.json)

    **Ev:fulfillmentstate:** Communicates the _real-time charging session state_ as sent back by the BPP.
...
*   Request: EV User tracks a live charging session in real-time: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/11_status/ev-charging-session-track.json)
...
*   Request: EV User receives live charging session details in real-time: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/12_on_status/ev-charging-session-on-track.json)

    **ev:charging\_periods:**\
    Represents the _current charging interval_ and real-time measurements captured during that period.

    1. **ev:dimensions:** Contains multiple _live telemetry readings_, including:
    2. **ENERGY:** Incremental energy added in the current interval (0.25 kWh).
    3. **POWER:** Current charging power rate (7.2 kW).
    4. **CURRENT:** Electrical current being drawn (16.0 A).
    5. **VOLTAGE:** Supply voltage level (230 V).
    6. **STATE\_OF\_CHARGE:** Vehicle’s current battery level (63%).
...
EV User receives live charging session details in real-time: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/12_on_status/ev-charging-session-on-track.json)
...
\`\`\`json { "ack\_status": "ACK", "timestamp": "2025-10-14T07:33:05Z" } \`\`\`
...
* Request: EV user reveives details in case of any error during a charging session: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/13_on_status/ev-charging-session-interrupt-on-status.json)
...
* Request: EV user receives final order details after the charging session ends: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/14_02_on_update/ev-charging-session-complete-on-update.json)
...
* EV user ends the charging session: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/14_01_update/ev-charging-session-end-update.json)
* Receives on\_update response with completed status. [Example](https://github.com/nirmal-inc/docs-test/blob/main/examples/ev-charging/v2/14_02_on_update/ev-charging-session-complete-on-update.json)
* Request:
...
* Successful Response: EV user cancels a charging slot reservation: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/19_cancel/ev-charging-cancel-reserved-slot.json)
...
* Successful Response: CPO cancels a charging session reservation: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/20_on_cancel/ev-charging-bpp-reservation-on-cancel.json)
...
* Request: CPO accepts rating: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/16_on_rating/ev-charging-session-on-rating.json)
...
* Request: EV user contacts support: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/17_support/ev-charging-session-support.json)
...
* Method: POST
* Use Cases: Raghav receives a response to his support request.
* Request: CPO returns support information: [Example](https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/ev-charging/v2/18_on_support/ev-charging-session-on-support.json)
