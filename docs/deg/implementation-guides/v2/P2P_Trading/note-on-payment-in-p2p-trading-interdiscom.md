# Payment Design for Inter-Utility Peer to Peer Energy Trading

Version 0.1 (Non-Normative)

## Table of contents

* [1. Overview](note-on-payment-in-p2p-trading-interdiscom.md#1-overview)
* [2. Design Principles](note-on-payment-in-p2p-trading-interdiscom.md#2-design-principles)
  * [2.1. Peer-to-Peer Transparency](note-on-payment-in-p2p-trading-interdiscom.md#21-peer-to-peer-transparency)
  * [2.2. Bill Component Transparency](note-on-payment-in-p2p-trading-interdiscom.md#22-bill-component-transparency)
  * [2.3. Settlement Flow](note-on-payment-in-p2p-trading-interdiscom.md#23-settlement-flow)
* [3. Sequence Diagram](note-on-payment-in-p2p-trading-interdiscom.md#3-sequence-diagram)
* [4. Payment Status Lifecycle](note-on-payment-in-p2p-trading-interdiscom.md#4-payment-status-lifecycle)
* [5. Bill Components](note-on-payment-in-p2p-trading-interdiscom.md#5-bill-components)
* [6. Message Flow Examples](note-on-payment-in-p2p-trading-interdiscom.md#6-message-flow-examples)
  * [6.1. on\_select: Settlement Quote + Accepted Payment Methods](note-on-payment-in-p2p-trading-interdiscom.md#61-on_select-settlement-quote--accepted-payment-methods)
  * [6.2. on\_init: Payment Terms Confirmation](note-on-payment-in-p2p-trading-interdiscom.md#62-on_init-payment-terms-confirmation)
  * [6.3. on\_confirm: Order Confirmation](note-on-payment-in-p2p-trading-interdiscom.md#63-on_confirm-order-confirmation)
  * [6.4. on\_update: Partial Delivery (Curtailment)](note-on-payment-in-p2p-trading-interdiscom.md#64-on_update-partial-delivery-curtailment)
  * [6.5. on\_status: Final Invoice (After Allocation)](note-on-payment-in-p2p-trading-interdiscom.md#65-on_status-final-invoice-after-allocation)
  * [6.6. on\_status: Settlement Complete](note-on-payment-in-p2p-trading-interdiscom.md#66-on_status-settlement-complete)
  * [6.7. on\_status: Trade Completed](note-on-payment-in-p2p-trading-interdiscom.md#67-on_status-trade-completed)
* [7. Key Design Decisions](note-on-payment-in-p2p-trading-interdiscom.md#7-key-design-decisions)
  * [7.1. Why Platform-to-Platform Settlement?](note-on-payment-in-p2p-trading-interdiscom.md#71-why-platform-to-platform-settlement)
  * [7.2. Customer Agency](note-on-payment-in-p2p-trading-interdiscom.md#72-customer-agency)
  * [7.3. Discom's Role](note-on-payment-in-p2p-trading-interdiscom.md#73-discoms-role)
* [8. Implementation Notes](note-on-payment-in-p2p-trading-interdiscom.md#8-implementation-notes)
  * [8.1. For Buyer Platforms (BAP)](note-on-payment-in-p2p-trading-interdiscom.md#81-for-buyer-platforms-bap)
  * [8.2. For Seller Platforms (BPP)](note-on-payment-in-p2p-trading-interdiscom.md#82-for-seller-platforms-bpp)
...
3. **Final Invoice (via on\_status)**: Buyer platform queries status; seller platform responds with invoice including BPP settlement account
...
| Status       | When                             | Meaning                                |
| ------------ | -------------------------------- | -------------------------------------- |
| `PENDING`    | on\_select                       | Awaiting buyer decision                |
| `INITIATED`  | init                             | Payment process started                |
| `AUTHORIZED` | on\_init → on\_confirm           | Funds reserved, trade approved         |
| `ADJUSTED`   | on\_update (curtailment)         | Amount changed due to partial delivery |
| `SETTLED`    | on\_status (settlement complete) | Money transferred to all parties       |
...
### 6.1. on\_select: Settlement Quote + Accepted Payment Methods
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/p2p-trading-interdiscom/v2/select-response.json">on_select Response</a></summary>
...
### 6.2. on\_init: Payment Terms Confirmation
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/p2p-trading-interdiscom/v2/init-response.json">on_init Response</a></summary>
...
### 6.3. on\_confirm: Order Confirmation

The confirmation response returns the full order details with payment status AUTHORIZED, mirroring the information from on\_init. This serves as the definitive record of the agreed trade terms.

<details>

<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/p2p-trading-interdiscom/v2/confirm-response.json">on_confirm Response</a></summary>
...
### 6.4. on\_update: Partial Delivery (Curtailment)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/p2p-trading-interdiscom/v2/on-update-response-curtailment.json">on_update Curtailment</a></summary>
...
### 6.5. on\_status: Final Invoice (After Allocation)
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/p2p-trading-interdiscom/v2/status-response-final-invoice.json">on_status Final Invoice</a></summary>
...
### 6.6. on\_status: Settlement Complete
...
<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/p2p-trading-interdiscom/v2/status-response-settlement-complete.json">on_status Settlement Complete</a></summary>
...
### 6.7. on\_status: Trade Completed

Final status shows the order and payment as complete.

<details>

<summary><a href="https://github.com/nirmal-inc/docs-test/blob/main/docs/examples/p2p-trading-interdiscom/v2/status-response-completed.json">on_status Completed</a></summary>
...
3. **On final invoice (on\_status)**: Validate settlement amount matches agreed catalog prices
...
4. **After allocation (on\_status)**: Provide final invoice with BPP settlement account and tracking URL
5. **On payment receipt**: Deduct seller platform fee, pay seller their net earnings, update status to SETTLED

***

_This design ensures that while platforms facilitate the transaction, customers remain the principals in a true peer-to-peer energy trade._
